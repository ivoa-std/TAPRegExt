...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="indentstep" select="'  '" />
   ...
   <xsl:variable name="cr"><xsl:text>
	...
	<xsl:variable name="crcr"><xsl:value-of select="concat($cr, $cr)"/>
	</xsl:variable>
    ...
    <xsl:template match="@type[.='vr:ResourceName']" 
    ...
    <xsl:template match="@type[.='vr:IdentifierURI']" 
                  priority="1" mode="type">
