...
the latter does not allow frament identifiers in VOResource 1.0. 
...
declare an RFC 2045 media type \citep{std:MIME} as well
...
standardIDs.
\item Made most former IVORNs IVOID to comply with a proposed
clarification of terminology in Identifiers 2.0
